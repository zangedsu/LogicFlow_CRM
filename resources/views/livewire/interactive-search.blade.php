<div class="relative flex flex-1" x-data="{ open: false }" @click.away="open = false" @close.stop="open = false">
    <form class="w-full"  action="#" method="GET">
        ...
        <div x-show="open"
            ...
            <div class="rounded-md ring-1 ring-black ring-opacity-5 bg-zinc-900/80 backdrop-blur min-h-28">
                ...
                <ul class="h-96 scroll-py-2 divide-y divide-gray-500 divide-opacity-20 overflow-y-auto">
                    <li class="p-2">
                        <h2 class="mb-2 mt-4 px-3 text-xs font-semibold text-gray-200">Вот что нашлось по запросу {{$searchText}}</h2>
                        <ul class="text-sm text-gray-400">
                            ...
                            <li class="group flex cursor-default select-none items-center rounded-md px-3 py-2">
                                ...
                                <!-- Not Active: "hidden" -->
                                <span class="ml-3  flex-none text-gray-400">Jump to...</span>
                            </li>
                        </ul>
                    </li>
