...
{{--    <table class="table-fixed dark:text-white text-black border-collapse border border-slate-500 w-full">--}}
{{--        <thead>--}}
{{--        <tr>--}}
{{--            <th>Имя</th>--}}
...
{{--                <tr>--}}
{{--                <td class="border border-slate-700">{{$client->name}}</td>--}}
{{--                <td class="border border-slate-500">{{$client->phone}}</td>--}}
{{--                <td class="border border-slate-500">{{$client->site}}</td>--}}
{{--                </tr>--}}
{{--            @endforeach--}}
    ...
    <li class="col-span-1 divide-y divide-gray-200 rounded-lg bg-white dark:bg-gray-800 shadow">
        <div class="flex w-full items-center justify-between space-x-6 p-6">
            <div class="flex-1 truncate">
                ...
                <p class="mt-1 truncate text-sm text-gray-500">{{$client->phone}}</p>
            </div>
            <div class=" flex h-10 w-10 flex-shrink-0 rounded-full bg-green-700" >A </div>
        </div>
        <div>
