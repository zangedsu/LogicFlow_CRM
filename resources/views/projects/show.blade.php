                ...
                <header>
                    ...
                    <nav class="flex overflow-x-auto border-b border-white/10 py-4">
                        <ul role="list" class="flex min-w-full flex-none gap-x-6 px-4 text-sm font-semibold leading-6 text-gray-400 sm:px-6 lg:px-8">
                            <li>
                                <a href="#" class="text-indigo-400">Обзор</a>
                            </li>
                            <li>
                                <a href="#" class="">Активность</a>
                            </li>
                            <li>
                ...
                <div class="border-t border-white/10 pt-11">
                    ...
                    <table class="mt-6 w-full whitespace-nowrap text-left">
                        ...
                        <tr>
                            ...
                            <th scope="col" class="hidden py-2 pl-0 pr-4 text-right font-semibold sm:table-cell sm:pr-6 lg:pr-8">Ответственные</th>
                        </tr>
                        </thead>
                        <tbody class="divide-y divide-white/5">
                        ...
                        <tr>
                            <td class="py-4 pl-4 pr-8 sm:pl-6 lg:pl-8">
                                <div class="flex items-center gap-x-4">
{{--                                    <img src="https://images.unsplash.com/photo-1519244703995-f4e0f30006d5?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="" class="h-8 w-8 rounded-full bg-gray-800">--}}
                                    <a href="{{route('tasks.show', ['id'=>$task->id])}}" class="truncate text-sm font-medium leading-6 text-white">{{$task->name}}</a>
                                </div>
                            </td>
                            <td class="hidden py-4 pl-0 pr-4 sm:table-cell sm:pr-8">
                                <div class="flex gap-x-3">
...
{{--                                    <span class="inline-flex items-center rounded-md bg-gray-400/10 px-2 py-1 text-xs font-medium text-gray-400 ring-1 ring-inset ring-gray-400/20">main</span>--}}
                        ...
                        <div class="mt-6">
                            <a wire:navigate href="{{route('tasks.create', ['project' => $project->id])}}" type="button" class="inline-flex items-center rounded-md bg-zinc-900/80 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:border duration-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                    ...
                    @else
                        <div class="text-center  rounded-lg p-6 mt-6">
                            ...
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">В данном проекте совсем нет задач, стоит их создать для начала работы</p>
                            <div class="mt-6">
                                <a wire:navigate href="{{route('tasks.create', ['project' => $project->id])}}" type="button" class="inline-flex items-center rounded-md bg-zinc-900/80 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:border duration-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                                    <svg class="-ml-0.5 mr-1.5 h-5 w-5" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                        <path d="M10.75 4.75a.75.75 0 00-1.5 0v4.5h-4.5a.75.75 0 000 1.5h4.5v4.5a.75.75 0 001.5 0v-4.5h4.5a.75.75 0 000-1.5h-4.5v-4.5z" />
