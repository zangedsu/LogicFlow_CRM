...
<html class="h-full bg-cover  bg-fixed dark:bg-gradient-to-br from-black via-red-900 to-teal-900" lang="{{ str_replace('_', '-', app()->getLocale()) }}" style="background-image: url('{{asset("wallpapers/dark-waves.jpg")}}')">
<head>
    <meta charset="utf-8">
...
{{--                                                <li class="hover:text-white hover:bg-gray-700 group p-2 rounded-md">Назначенные мне</li>--}}
                            ...
                            <li>
                                <a wire:navigate href="{{route('sprints.index')}}" class="text-gray-400 hover:text-white hover:bg-gray-800 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold duration-300 @if(request()->routeIs('calendar')) border @endif">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
